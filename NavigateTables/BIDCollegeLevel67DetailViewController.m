...
- (void)viewDidLoad
{
    ...
    [self createTableOneNamed : @"CAO_collegeLevel67GenData_7add_fields_1" withField1: @"courseID" withField2: @"courseName" withField3: @"abbrev. courseName" withField4: @"college" withField5: @"2010" withField6: @"2011" withField7: @"2012" withField8: @"NotAllonPtsOffered" withField9: @"MusictestInterview" withField10: @"Interview" withField11: @"testInterviewPortfolio" withField12: @"AQA" withField13: @"Matriculate" ];
    ...
    for(int i=0;i < TABLE_FIELD_NUM*TABLE_ROW_NUM ;i+=TABLE_FIELD_NUM)
    {
        ...
        [self insertRecordIntoTableNamed: @"CAO_collegeLevel67GenData_7add_fields_1"
...
-(void) viewWillAppear:(BOOL)animated;
{
    ...
    NSString *mainTable=@"CAO_collegeLevel67GenData_7add_fields_1";
    ...
    NSLog(@"college_course_counter = %d --  size of array is = %d ",college_course_counter,[course_76Array count]);
...
-(IBAction)namePressed:(UIButton *)sender
{
    ...
    full_course_name   =[self getAllRowsFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    quota_reached_exist=[self getFirstExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    
    music_test_interview=[self getSecondExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    Interview=[self getThirdExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    testInterviewPortfolio=[self getFourthExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    AQA=[self getFifthExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
    VacantPlaces=[self getSixthExtraInfoFromTableNamed : @"CAO_collegeLevel67GenData_7add_fields_1" sortBy : name];
...
-(NSString *) filePath;
{
    ...
    return[documentsDir stringByAppendingPathComponent:@"cao_db_level67_data_1.sql"];
}
