...
- (void)viewDidLoad
{
    ...
    [self createTableOneNamed : @"CAO_collegeLevelGenData_6addFieldsTest" withField1: @"courseID" withField2: @"courseName" withField3: @"abbrev. courseName" withField4: @"college" withField5: @"2010" withField6: @"2011" withField7: @"2012" withField8: @"NotAllonPtsOffered" withField9: @"MusictestInterview" withField10: @"Interview" withField11: @"testInterviewPortfolio" withField12: @"AQA" withField13: @"VacantPlaces"];
    ...
    for(int i=0;i < TABLE_FIELD_NUM*TABLE_ROW_NUM ;i+=TABLE_FIELD_NUM)
    {
        ...
        [self insertRecordIntoTableNamed: @"CAO_collegeLevelGenData_6addFieldsTest"
...
-(void) viewWillAppear:(BOOL)animated;
{
    ...
    NSString *mainTable=@"CAO_collegeLevelGenData_6addFieldsTest";
...
-(IBAction)namePressed:(UIButton *)sender
{
    ...
    full_course_name   =[self getAllRowsFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    quota_reached_exist=[self getFirstExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    
    music_test_interview=[self getSecondExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    Interview=[self getThirdExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    testInterviewPortfolio=[self getFourthExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    AQA=[self getFifthExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    VacantPlaces=[self getSixthExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
    Project_portfolio=[self getSeventhExtraInfoFromTableNamed : @"CAO_collegeLevelGenData_6addFieldsTest" sortBy : name];
...
-(NSString *) filePath;
{
    ...
    return[documentsDir stringByAppendingPathComponent:@"cao_db_cpugenerated_data_add6FieldsTest.sql"];
}
