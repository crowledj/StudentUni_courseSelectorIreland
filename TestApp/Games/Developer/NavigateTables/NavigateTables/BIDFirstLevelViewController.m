...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    // comment out attempting changes for multi table view
    /*
    if (self) {
        // Custom initialization
        self.title = @"CAO Points Guide";
        //self.controller = @[];
        self.controller = @[[[BIDContentViewController alloc] init]];
        
        BIDFirstLevelViewController *controller = self.controller[indexPath.row];
        
        //self.controller2 = @[[[BIDCollegeLevelViewController alloc] init]];
    }
     */
    
    // end comment out attempting changes for multi table view
    ...
    if (self) {
        ...
        /* reverse next two lines to retrieve old working version*/
        //self.controller = @[[[BIDContentViewController alloc] init]];
